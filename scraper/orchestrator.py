...
ALL_SCRAPERS = [
    ...
    SunlifeScraper,       # priority 8
    SunsetRealtorsScraper,  # priority 8
    CuracaoExclusiveScraper,  # priority 8
    RealEstateAgencyCBScraper,  # priority 8
    AmbienteScraper,      # priority 8
    PalmstoneScraper,     # priority 8
    RealEstateCaribeScraper,  # priority 8
    RuselerScraper,       # priority 8
    LandmarkScraper,      # priority 8
    KostabonScraper,      # priority 8
    SimmerScraper,        # priority 8
    TopMakelaarScraper,   # priority 8
    BruDeRoqueScraper,    # priority 8
    DomicilieScraper,     # priority 8
    ...
    MartisPartnersScraper,  # priority 8
    CurEstatesScraper,   # priority 8
